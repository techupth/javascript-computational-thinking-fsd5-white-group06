...
let maxValueOrder = orders[0].productPrice * orders[0].productQuantity;
console.log(maxValueOrder);
...
console.log(`The most expensive order is order id 8 (${maxValueOrder})`);
